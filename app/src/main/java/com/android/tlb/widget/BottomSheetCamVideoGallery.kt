...
import kotlinx.android.synthetic.main.fragment_bottom_sheet_cam_video_gallery.view.*

class BottomSheetCamVideoGallery: BottomSheetDialogFragment() {

    private var mBottomSheetListener: BottomSheetListener? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        val v = inflater.inflate(R.layout.fragment_bottom_sheet_cam_video_gallery, container, false)
        ...
        v.video.setOnClickListener {
            mBottomSheetListener!!.onOptionClick("VIDEO")
            dismiss()
        }
